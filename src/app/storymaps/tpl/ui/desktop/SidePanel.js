define(["lib-build/tpl!./SidePanelSection",
    "lib-build/tpl!./SidePanelSectionTime",
    ...
    function(
        ...
        return function SidePanel(container, isInBuilder, navigationCallback)
        {
            ...
            {
                var result = $.grep(app.cfg.TIMESLIDERMAPS, function (e) { return e.section === index;});
                var template = null;
                var optHtmlClass = "";
                ...
                if (result.length === 0) {
                    ...
                    template = viewSectionTimeTpl({
                        optHtmlClass: optHtmlClass,
                        title: StoryText.prepareEditorContent(title),
                        sectionId:index
                    });

                    app.data.setTimeSection({sectionIndex: index, template: template });
                }
                return template;
