    ...
    function (
        ...
        return function MainView(builderView) 
        {
            ...
            {			
                ...
                topic.subscribe("story-navigate-section", navigateStoryToIndex);  //not published
            ...
            {
                console.log('mainview js line 190 storystorage: ' + app.data.getStoryStorage());
                //check for time maps and load csv data as needed
                if (app.data.getStoryStorage() == "WEBAPP") {
                    console.log('going to storyDataReady');
                    storyDataReady();
                }
            ...
            this.loadWebmap = function(webmapIdOrJSON, container, extent)
            {
                ...
                //console.log('loadwebmap webmapIdOrJSON: ' + ' first timeslider map id: ' +  app.cfg.TIMESLIDERMAPS[0]);
                //var idx = app.cfg.TIMESLIDERMAPS.indexOf(webmapIdOrJSON);
                //console.log('idx: ' + idx);
                //var popup = $("body").width() > 768 ? null : new PopupMobile(null, $("<div></div>")[0]);
                var popup = null;
                var myMap = arcgisUtils.createMap(webmapIdOrJSON, container, {
                    mapOptions: {
                        slider: true,
                        autoResize: false,
