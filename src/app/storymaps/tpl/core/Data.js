define(["./WebApplicationData",
    ...
    function(
        ...
        return function Data()
        {
            ...
            {
                console.log('in getStorySections');
                var allSections = [],
                    filteredSections = [];
            ...
            this.getWebmapsInfo = function()
            {
                ...
                $.each(Object.keys(webmapsInfoHash), function(i, webmap){
                    ...
                    console.log('webmapsInfoArray', webmapsInfoHash[webmap].sections);
                    webmapsInfoArray.push({
                        id: webmap,
            ...
            //custom time maps
            this.getwebmapsTimeTextData = function () {
                return this._webmapsTimeTextArray;
            };
            this.setwebmapsTimeTextData = function (dataObj) {
                this._webmapsTimeTextArray.push(dataObj);
            };
            //custom time sections
            this.getTimeSections = function () {
                return this._timeSections;
            };
            this.setTimeSection = function (sectionObj) {
                this._timeSections.push(sectionObj);
            };
